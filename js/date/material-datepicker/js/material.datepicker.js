	...
	var pickerHtml =
   	[
	   	'<div class="material-datepicker hide" tabindex="0">',
	    	...
	    	'</section>',
	    	'<section class="middle-date color-bg">',
	    	...
	    	'<section class="calendar no-select">',
	    		'<a data-bind="click: prevMonth" class="control prev color"> &#xf053 </a>',
	    		'<a data-bind="click: nextMonth" class="control next color"> &#xf054 </a>',
