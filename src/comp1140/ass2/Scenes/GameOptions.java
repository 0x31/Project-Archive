...
public class GameOptions extends Scene {
    public GameOptions(Group root, double width, double height, Blokus parent) {
        ...
        Button button0 = new Button("Red?: Bot");button0.setOnAction(new EventHandler<ActionEvent>() {public void handle(ActionEvent e) { parent.toGame(); }}); button0.setMinSize(160, 40); button0.setLayoutX(200 - button0.getMinWidth() / 2); button0.setLayoutY(300); button0.getStyleClass().add("button"); root.getChildren().add(button0);
